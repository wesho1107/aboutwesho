...
export default function SocialCard({ item }: { item: SocialItemProps }) {
  return (
    <a 
      ...
      className="group col-span-2 flex justify-between items-center gap-x-2 border rounded-2xl p-4 hover:shadow-md transition-shadow duration-300"
    >
      ...
      <FaAngleRight className="w-4 h-4 shrink-0 text-zinc-400 transition-colors group-hover:text-zinc-500" />
    </a>
  )
}
